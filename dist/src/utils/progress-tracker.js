...
class ProgressTracker {
    ...
    _shouldLog() {
        return (this.completed % Math.max(1, Math.floor(this.total / this.logFrequency)) === 0 || // Log based on frequency
    ...
    _logProgress() {
        ...
        console.log(`${langInfo}${progressBar} ${percentText} | ${itemsText}items | ` +
