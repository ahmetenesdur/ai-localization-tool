...
class LengthChecker {
    ...
    getStandardModeConfig(lengthControl, mode, targetLang, context) {
        const deviation = lengthControl.rules?.[mode] ||
            this.defaultConfig.maxDeviation;
        return {
            mode,
            targetLang,
            context,
            maxDeviation: typeof deviation === "number" ? deviation : this.defaultConfig.maxDeviation,
...
exports.default = LengthChecker;
//# sourceMappingURL=length-checker.js.map